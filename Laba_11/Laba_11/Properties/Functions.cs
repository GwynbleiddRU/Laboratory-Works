...
namespace SuperFunctions
{
        ...
        //ввод названия государства
        {
            ...
            do
            {
                ...
                if (!ok) {
                    ...
                    Console.WriteLine("  Ошибка ввода: введите одно слово ");
                    Console.ForegroundColor = ConsoleColor.White;
                    ok = false; }
            } while (!ok);
            return name;
    ...
    //Функции для строк
    {
        ...
        //Создание строки
        {
            ...
            Random rnd = new Random();
            k = Functions.Choice(2, 1, "Ошибка. Выберите пункт из меню:", "Как вы хотите создать строку?" +
